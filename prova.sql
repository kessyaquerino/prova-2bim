...
VALUES ('As Cronicas de Nárnia', 'C.S. Lewis', '1950', TRUE, 'fantasia', '978-0064471190', 'HaperCollins', '768', 'Francês');
...
/*ex10*/
SELECT * FROM Livros 
WHERE nome like 'S%'and  ano_publicacao between 1975 and 1990;
